...
| **2026-08-20** | `golden_dataset.json` (`mturn_16`) | Mapped exact original query "Why does this artificially reduce variance?" to pure missing-data variance posts `["280130", "118211", "303737"]`. | Removed tangential outlier/Likert posts (`78065`, `440047`) and replaced with exact missing data discussions explaining why single imputation artificially deflates variances and covariances. | High-precision missing data variance coverage. |
